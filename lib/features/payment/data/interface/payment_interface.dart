...
// lib/features/payment/data/datasources/payment_interface.dart
...
Future<void> manualTest({
  ...
  /// Returns null when user has no subscription → show SubscriptionScreen.
  Future<MySubscriptionModel?> getMySubscription({required String userId});

  Future<InitiatePaymentResponse> initiatePayment(InitiatePaymentRequest request);
}