// // lib/features/payment/presentation/screens/fawry_screen.dart
...
// /// Screen shown when user selects "Fawry Pay" as payment method.
// ///
// /// Flow:
// ///   1. Initiates payment → backend returns transactionId (the Fawry reference code).
// ///   2. Displays the reference code so the user can pay at any Fawry POS.
// ///   3. Auto-triggers ManualActivateEvent with the transactionId as orderId.
// ///
// /// Usage:
// /// ```dart
// /// Navigator.push(context, MaterialPageRoute(
// ///   builder: (_) => FawryScreen(plan: selectedPlan),
// /// ));
// /// ```
// class FawryScreen extends StatefulWidget {
//   final SubscriptionPlanModel plan;

//   const FawryScreen({super.key, required this.plan});
...
//   /// Null = payment not yet initiated / loading; set once backend responds.
...
//   void initState() {
//     super.initState();
//     // Initiate payment immediately when screen opens (no mobile number needed for Fawry)
...
//           });
//           // ManualActivateEvent is auto-fired by the BLoC at this point
//         }
...
// // ─────────────────────────────────────────────
// //  Fawry logo widget (circular arrows on yellow bg)
// // ─────────────────────────────────────────────
// class _FawryLogo extends StatelessWidget {
//   @override
//   Widget build(BuildContext context) {
//     return Container(
//       width: 130,
