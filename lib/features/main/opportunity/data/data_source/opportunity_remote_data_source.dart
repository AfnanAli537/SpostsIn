...
class OpportunityRemoteDataSourceImpl implements OpportunityInterface {
  ...
  Future<void> postOpportunity({
    ...
    try {
      final Map<String, dynamic> data = {
        ...
        if (preferredClubExperience != null)
          'MatchCriteria.PreferredClubExperience': preferredClubExperience,
        if (requiredCertifications != null && requiredCertifications.isNotEmpty)
          'MatchCriteria.RequiredCertifications': requiredCertifications,
        if (mediaFile != null)
      ...
      log('Opportunity created successfully: ${formData.fields}');
    } on DioException catch (e) {
      throw ApiErrorHandler.handleDioError(e);
    }
  }
  ...
  Future<void> updateOpportunity({
    ...
    try {
      ...
      log('Opportunity updated successfully: ${formData.fields}');
    } on DioException catch (e) {
      throw ApiErrorHandler.handleDioError(e);
    }
  }
