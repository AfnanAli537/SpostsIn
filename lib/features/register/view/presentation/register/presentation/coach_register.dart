...
import 'package:sports_in/features/register/models/coach_response_model.dart';
...
class CoachRegisterScreen extends StatelessWidget {
  CoachRegisterScreen({super.key});
