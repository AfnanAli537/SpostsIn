...
class OtherRegisterScreen extends StatefulWidget {
  const OtherRegisterScreen({super.key});

  @override
  State<OtherRegisterScreen> createState() => _OtherRegisterScreenState();
}

class _OtherRegisterScreenState extends State<OtherRegisterScreen> {
